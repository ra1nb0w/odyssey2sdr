/**********************************************************************
 * 8x5 STANDARD FONT
 * font is defined as 8x5, but library adds a 0-column to the right
 * of every char, so the font is 8x6
 *
 * for more fonts see https://github.com/olikraus/u8glib/tree/master/fntsrc
 **********************************************************************/
