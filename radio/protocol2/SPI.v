...
/*
	...
	Bit 32 - N.C. 					U3 - D0
	Bit 33 - N.C. 					U3 - D1
	Bit 34 - N.C. (100W)**		U3 - D2			** TRX)STATUS (500W PA); same as BIT43, required by Mentor
...
wire [47:0] send_data = if_DITHER ?
	{16'b0, 16'b0, Alex_data[23], Alex_data[22], Alex_data[21], Alex_data[20], Alex_data[31], Alex_data[30], Alex_data[6], Alex_data[5],
    Alex_data[4], Alex_data[1], Alex_data[2], Alex_data[12], Alex_data[3], Alex_data[25], Alex_data[26], Alex_data[27]} :
	{16'b0, Alex_data[31:19], Alex_data[27], Alex_data[17:0]};
`endif
...
3'd0:	begin
		if (reset | ( enable & (send_data != previous_Alex_data))) begin
			previous_Alex_data <= reset ? 48'd0 : send_data; // save current data right away, it could change
`ifdef ORION7000
			data_count <= 6'd47;				// set starting bit count to 47
`else
			data_count <= if_DITHER ? 6'd15 : 6'd31;
`endif
			spi_state <= 3'd1;
		end
